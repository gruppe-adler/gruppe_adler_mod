...
if (ace_interact_menu_menuBackground == 1) then {["ace_medical_gui_id", true] call ace_common_fnc_blurScreen};
...
_ctrlTitle ctrlSetText ([GVAR(target)] call ace_common_fnc_getName);
